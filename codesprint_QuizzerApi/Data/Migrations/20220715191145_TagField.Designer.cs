...
namespace Data.Migrations
{
    ...
    [Migration("20220715191145_TagField")]
    partial class TagField
    {
            ...
            modelBuilder.Entity("Domain.Models.Question", b =>
                {
                    ...
                    b.HasIndex("QuestionText", "QuizId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Models.Quiz", b =>
                {
                    ...
                    b.Property<string>("MessageOnFail")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MessageOnPass")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("RandomiseQuestionOrder")
                        .HasColumnType("bit");

                    b.Property<string>("ShowCorrectAnswer")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Models.Question", b =>
                {
                    ...
                    b.HasOne("Domain.Models.QuestionType", "Type")
                        .WithMany()
